      ...
      <div className="container about-container">
        ...
        <div className="about-content">
          <div className="about-text">
            <p>
              I'm a recent Computer Science Engineering Post graduate with a strong foundation in programming, data
          ...
          <div className="about-image">
            <img src={profileImage} alt="Barla Mahender" className="profile-image" />
            <h3>Barla Mahender</h3>
